...
extern struct { char _[16]; } D_800B0D10_o __asm__("D_800B0D10");
...
#define D_800B0D10 (*(u8 **)&D_800B0D10_o)
...
int Scene_UpdateBgDraw(void) {
    ...
    Render_TransformVertices(bg_actor);
    Render_TransformMorphVertices(bg_actor, D_800B89F8);

    if ((D_8009D1A0 & 2) || D_8009D254[0x252] != 0) {
        Render_DrawEntity(bg_actor, D_800B89F8);
    }
