...
INCLUDE_ASM("asm/USA/main/nonmatchings/battle/tu_04204C", Inv_BuildWeaponList);

INCLUDE_ASM("asm/USA/main/nonmatchings/battle/tu_04204C", BattleCmd_LoadWeaponModifiers);
