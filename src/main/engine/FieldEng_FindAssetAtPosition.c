...
void *func_800C6764(char *obj, void *asset, char *pos) {
    void *result = 0;

    if (FieldEng_GetStatus(obj) == 3 || FieldEng_GetStatus(obj) == 4) {
        result = Asset_Find08w(asset, *(void **)(*(char **)(*(char **)(obj + 8) + 0) + 8),
                               *(s16 *)(pos + 0), *(s16 *)(pos + 4), *(s16 *)(pos + 8));
    }
