...
int func_800C9D9C(void *arg0, void *arg1, u8 *anim) {
    ...
    entry = D_800E0AF8 + ((*(u16 *)(*(char **)(*(char **)D_8009D254 + 0x68) + 6) - 1) << 3);
    model = *(char **)(D_800E27A4 + 0x238);
    ApplyMatrixSV(model + 0x260, entry, &out);

    *(u16 *)(anim + 0x8) = D_800E2358 + out.vx;
    *(u16 *)(anim + 0xA) = D_800E235A + out.vy;
    *(u16 *)(anim + 0xC) = D_800E235C + out.vz;
