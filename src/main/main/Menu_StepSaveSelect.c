...
M2C_UNK func_80052C08();
M2C_UNK func_80052E30();
s32 func_8005DC4C();
s32 Draw_MeasureTextWidth();
s32 func_80062A20(s32, s32);
void *func_80062D2C();
...
extern struct { char _[16]; } func_8004F950_o __asm__("func_8004F950");
#define func_8004F950 (*(M2C_UNK *)&func_8004F950_o)
            ...
            if (temp_v0_2 != NULL) {
                ...
                if ((temp_cf50 != 0) || (*temp_v0_2 != 2)) {
                    ...
                    if (temp_cf50 != 0) {
                        ...
                        if (D_8009CF4C != 2) {
                            temp_v0_3 = func_80062D2C(0x29, temp_s2, 0, 1);
