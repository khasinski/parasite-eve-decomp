...
void Akao_SetVoiceLoopAddr(void *arg0, u32 arg1) {
    ...
    while ((u8) M2C_FIELD(var_s0, u8 *, 8) < 0x80U) {
        var_s0 += 8;
        var_a0 += 1;
    }
    var_s0 = M2C_FIELD(arg0, void **, 0x18);
...
loop_4:
        var_v1 += 1;
        if ((u8) M2C_FIELD(var_s0, u8 *, 2) < arg1) {
            var_s0 += 8;
            if (var_v1 < var_a0) {
                goto loop_4;
            }
    ...
    temp_v1 = M2C_FIELD(var_s0, u8 *, 0);
    temp_a0 = M2C_FIELD(arg0, u16 *, 0x5A);
    if (temp_v1 < 0x20U) {
        if (temp_a0 != temp_v1) {
            goto block_10;
        }
...
block_10:
        temp_v1_2 = M2C_FIELD(var_s0, u8 *, 8);
...
block_14:
            ...
            temp_a1 = var_a1 << 6;
            SeqOp_SetVoiceInstrument(arg0, (u8 *)&D_800B2900_o + temp_a1, *(s32 *)((u8 *)&D_800B2900_o2 + temp_a1));
