...
GteMatrix *RotMatrix(GteShortVector *angles, GteMatrix *matrix) {
    ...
    register s32 negative_sy asm("$12");
...
x_ready:;
    ...
    word = *(u32 *)((char *)D_800966EC + temp);
    PE1_NOP_MEMORY_DEP("r", word);
    negative_sy = ((u32)word) << 16;
    negative_sy = (s32)negative_sy >> 16;
    value = 0U - (u32)negative_sy;
    cy = (s32)word >> 16;
    goto y_ready;
positive_y:;
    temp = ((u32)word) << 2;
...
z_ready:;
    product = (unsigned long long)(u32)cz * (u32)cy;
    asm volatile("" : : "x"(product) : "memory");
    ...
    angle = (s32)value >> 12;
    asm volatile("" : "=r"(angle) : "0"(angle));
    product = (unsigned long long)(u32)cz * (u32)negative_sy;
    asm volatile("" : : "x"(product) : "memory");
    matrix->m[0][1] = angle;
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
    ...
    product = (unsigned long long)(u32)temp * (u32)sx;
    asm volatile("" : : "x"(product) : "memory");
    PE1_NOP_MEMORY_DEP("x", product);
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
    ...
    asm volatile("" : "=r"(angle) : "0"(angle));
    product = (unsigned long long)(u32)temp * (u32)cx;
    asm volatile("" : : "x"(product) : "memory");
    matrix->m[1][0] = angle;
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
    ...
    asm volatile("" : "=r"(angle) : "0"(angle));
    PE1_NOP_MEMORY_DEP("r", angle);
    product = (unsigned long long)(u32)sz * (u32)sx;
    asm volatile("" : : "x"(product) : "memory");
    PE1_NOP_MEMORY_DEP("x", product);
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
    ...
    asm volatile("" : "=r"(value) : "0"(value));
    word = (s32)value >> 12;
    value = (u32)word + angle;
    asm volatile("" : "=r"(value) : "0"(value));
    product = (unsigned long long)(u32)sz * (u32)negative_sy;
    asm volatile("" : : "x"(product) : "memory");
    matrix->m[2][0] = value;
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
    ...
    asm volatile("" : "=r"(angle) : "0"(angle));
    PE1_NOP_MEMORY_DEP("r", angle);
    product = (unsigned long long)(u32)cz * (u32)sx;
    asm volatile("" : : "x"(product) : "memory");
    PE1_NOP_MEMORY_DEP("x", product);
    PE1_NOP_MEMORY_DEP("x", product);
    asm volatile("" : "=l"(low) : "x"(product));
