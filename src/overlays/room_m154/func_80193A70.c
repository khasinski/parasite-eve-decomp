...
extern int RoomLib_Set4ClearSignal_801941D0(RoomEnt *o);

int func_80193A70(RoomEnt *o, int mode, unsigned int op, int arg0, int arg1, int arg2) {
    char *p = (char *)o + 0xC;
...
case0:
    ...
    if (D_8009D20C != 0) {
        ...
        RoomLib_Set4ClearSignal_801941D0(o);
    } else {
        RoomLib_Set4ClearSignal_801941D0(o);
    }
    goto ret;
