...
typedef struct Overlay024MatrixSeed16 {
    s32 words[4];
} Overlay024MatrixSeed16;
...
void func_801915A8(void *arg0, Overlay024VariantControl *control, Overlay024Variant290State *state) {
