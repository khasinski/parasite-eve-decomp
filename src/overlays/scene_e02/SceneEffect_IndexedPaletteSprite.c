...
extern GteRotation D_80195668;
extern RenderColor D_80195670;
int func_80194680(int mode, GteShortVector *effect) {
...
render:
    ...
    func_800CEE20(effect, &D_80195668, (s16)size, (s16)size,
                   texture, clut, 1,
