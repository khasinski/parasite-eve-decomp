...
void func_80078CC4(SceneE05Matrix *matrix, SceneE05Vec4 *scale);
void func_800C2EAC(u8 arg0);
void func_800C2FF0(s32 arg0, s32 arg1);
void func_800C3098(s32 arg0);
void func_800C3238(s32 arg0);
void func_800C42A4(void *arg0, SceneE05Matrix *matrix, s32 arg2);

void func_8018F970(void) {
    SceneE05Matrix matrix;
    SceneE05Vec4 scale;
    char *owner;
