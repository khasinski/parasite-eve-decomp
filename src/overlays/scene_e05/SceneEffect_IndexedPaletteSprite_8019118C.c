...
extern GteRotation D_801920CC;
extern RenderColor D_801920D4;
int func_8019118C(int mode, GteShortVector *effect) {
...
render:
    ...
    func_800CEE20(effect, &D_801920CC, (s16)size, (s16)size,
                   texture, clut, 1,
