...
extern int RoomLib_Set4ClearSignal_80194E14(RoomEnt *o);

int func_801946B4(RoomEnt *o, int mode, unsigned int op, int arg0, int arg1, int arg2) {
    char *p = (char *)o + 0xC;
...
case0:
    ...
    if (D_8009D20C != 0) {
        ...
        RoomLib_Set4ClearSignal_80194E14(o);
    } else {
        RoomLib_Set4ClearSignal_80194E14(o);
    }
    goto ret;
