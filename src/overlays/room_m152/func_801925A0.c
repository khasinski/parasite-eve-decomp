...
extern int RoomLib_Set4ClearSignal_80192D00(RoomEnt *o);

int func_801925A0(RoomEnt *o, int mode, unsigned int op, int arg0, int arg1, int arg2) {
    char *p = (char *)o + 0xC;
...
case0:
    ...
    if (D_8009D20C != 0) {
        ...
        RoomLib_Set4ClearSignal_80192D00(o);
    } else {
        RoomLib_Set4ClearSignal_80192D00(o);
    }
    goto ret;
