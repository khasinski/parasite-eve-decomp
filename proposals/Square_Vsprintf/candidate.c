/* Best stock-pipeline candidate. GCC 2.7.2 with the profile below emits the
 * retail 0x250-byte frame, register saves, 45-entry switch-table topology and
 * the retail non-nop opcode histogram. The remaining eight missing nops are a scheduler
 * difference from Psy-Q's compiler. */
