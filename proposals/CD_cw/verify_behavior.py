...
def run(command, null_parameter, null_result, mode, scenario, callbacks, debug, candidate):
    ...
    cpu.mem_write(0x9B294, b'\x02\x04\x04')
    ...
    api = {int(symbols[name], 16): name for name in names}
...
print(f'PASS {count} cases: parameter validation, state, FIFO, callbacks, timeout paths and results')
